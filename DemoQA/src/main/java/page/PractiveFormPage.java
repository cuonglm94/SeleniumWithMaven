...
public class PractiveFormPage extends Page{
	...
	public void inputData(Map data) {
		...
		//Nhập Email
		driverWeb.findElement(By.xpath("//input[@id='userEmail']")).sendKeys(data.get("Email").toString());
		...
		//driverWeb.findElement(By.id("dateOfBirthInput")).sendKeys(data.get("Date of Birth(DD MMM YYYY)").toString());
		driverWeb.findElement(By.id("subjectsInput")).sendKeys(data.get("Subjects").toString());
...
//		//Nhập firtName
//		driverWeb.findElement(By.id("firstName")).sendKeys(data.get("First name"));
//		//Nhập LastName
//		driverWeb.findElement(By.id("lastName")).sendKeys(data.get("Last name"));
//		//Nhập Email
//		driverWeb.findElement(By.xpath("//input[@id='userEmail']")).sendKeys(data.get("Email"));
//		//Click chọn giới tính
